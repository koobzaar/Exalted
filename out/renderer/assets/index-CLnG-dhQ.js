...
function Skin({
  ...
  const skinRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    const img = new Image();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: chromas.length > 0 && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          className: "chromas",
          initial: { opacity: 0 },
          ...
          children: chromas.map((chroma) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
...
const playButton = "" + new URL("play-button-arrowhead-DgQF1f35.png", import.meta.url).href;
const birds = "" + new URL("birds-D6UQw4j4.png", import.meta.url).href;
const ipcHandle = async () => {
  const skins = await window.electron.ipcRenderer.invoke("get-lol-catalog");
  return skins;
};
const App = () => {
  const [skins, setSkins] = reactExports.useState([]);
  const [selection, setSelection] = reactExports.useState({
    championName: null,
    skinId: null,
    chromaId: null
  });
  const [selectedSkinUrl, setSelectedSkinUrl] = reactExports.useState(null);
  reactExports.useEffect(() => {
    ipcHandle().then((skins2) => {
      setSkins(skins2);
    }).catch((error) => {
  ...
  const handleChromaClick = (skinId, chromaId) => {
    setSelection((prev) => ({
      ...prev,
      skinId,
      chromaId
  ...
  const handleInjectClick = () => {
    if (selectedSkinUrl) {
      window.electron.ipcRenderer.invoke("inject-skin", selectedSkinUrl).then(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "exalted", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "title", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "logo-title-wrapper", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { id: "birds-logo", src: birds, alt: "Birds" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Exalted" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "A League of Legends skin changer" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "close-minimize", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "minimize", onClick: minimizeApp, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "-" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "close", onClick: closeApp, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "x" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "champions-list", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "champions", children: skins.map((champion) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.li,
        {
          ...
          whileTap: { scale: 0.95 },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "champion-square-holder", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { id: "champion-name", children: champion.championName })
          ]
        },
        champion.championName
      )) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: selection.championName && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.section,
        {
          ...
          transition: { duration: 0.3 },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "blank_top" }),
            skins.find((champion) => champion.championName === selection.championName)?.skins.map((skin) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "blank_bottom" })
          ]
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "info" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inject-button", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "inject", onClick: handleInjectClick, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { id: "play-button", src: playButton, alt: "Play button" }) }) })
    ] })
  ] }) });
};
